...
#Some samples had a low quality, that is why I tested several different parameters
# and now the parameters that I use is: maxEE (8,8), and truncLen = c(260,240)
...
# and now the parameters that I use is: maxEE (2,2), and truncLen = c(260,240)
#Assigning the filenames for the output of the filtered reads to be stored as fastq.gz files.
